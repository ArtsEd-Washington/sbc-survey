...
Use the following columns:
| esd | esd_name | district | type | position | name | question1 | response1 | question2 | response2 | question3 | response3 | question4 | response4 | question5 | response5 | question6 | response6 |
|-----|----------|----------|------|----------|------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
|     |          |          |      |          |      |           |           |           |           |           |           |           |           |           |           |           |           |

Notes:
- esd: use just the number i.e. "189" not "ESD189" district
- district: must be just base name of district i.e. "Lynden" not "Lynden School District #504". Double-check these names against the existing names identified in the yyyy-districts.csv file. Example "Seattle Public Schools" must be just "Seattle". 
...
To build/rebuilt the application (after changes made):
